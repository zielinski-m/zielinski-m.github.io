$(document).ready(function() {
    const apiRoot = 'https://task-web-application-1.michalzielins12.repl.co/v1/tasks';
    const trelloApiRoot = 'https://task-web-application-1.michalzielins12.repl.co/v1/trello';
